...
void project_tests::test_mathSum_data(){
    ...
    QTest::newRow("row5")<<"91"<<"10"<<"101";
    QTest::newRow("row6")<<"16"<<"14"<<"30";
    QTest::newRow("row7")<<"61"<<"41"<<"102";
    QTest::newRow("row8")<<"109"<<"1"<<"110";
    QTest::newRow("row9")<<"123456789987654321"<<"2"<<"123456789987654323";
    QTest::newRow("row10")<<"123456789987654321"<<"3"<<"123456789987654324";
    QTest::newRow("row11")<<"123456789987654321"<<"4"<<"123456789987654325";
    QTest::newRow("row12")<<"99999999"<<"88888888"<<"188888887";
    QTest::newRow("row13")<<"123456789"<<"987654321"<<"1111111110";
    QTest::newRow("row14")<<"9999999999"<<"100"<<"10000000099";
    QTest::newRow("row15")<<"123456789987654321"<<"123456789987654321"<<"246913579975308642";
}
...
void project_tests::test_mathNeg_data(){
    ...
    QTest::newRow("row6")<<"40"<<"39"<<"1";
    QTest::newRow("row7")<<"61"<<"41"<<"20";
    QTest::newRow("row8")<<"102"<<"41"<<"61";
    QTest::newRow("row9")<<"123456789987654321"<<"2"<<"123456789987654319";
    QTest::newRow("row10")<<"123456789987654321"<<"3"<<"123456789987654318";
    QTest::newRow("row11")<<"123456789987654321"<<"4"<<"123456789987654317";
    QTest::newRow("row12")<<"99999999"<<"88888888"<<"11111111";
    QTest::newRow("row13")<<"123456789"<<"987654321"<<"-864197532";
    QTest::newRow("row14")<<"9999999999"<<"100"<<"9999999899";
    QTest::newRow("row15")<<"123456789987654321"<<"123456789987654321"<<"0";
}
...
void project_tests::test_mathMul_data(){
    ...
    QTest::newRow("row4")<<"2"<<"2"<<"4";
    QTest::newRow("row5")<<"8"<<"2"<<"16";
    QTest::newRow("row6")<<"16"<<"14"<<"224";
    QTest::newRow("row7")<<"61"<<"41"<<"2501";
    QTest::newRow("row8")<<"123456789987654321"<<"2"<<"246913579975308642";
    QTest::newRow("row9")<<"123456789987654321"<<"3"<<"370370369962962963";
    QTest::newRow("row10")<<"123456789987654321"<<"4"<<"493827159950617284";
    QTest::newRow("row11")<<"99999999"<<"88888888"<<"8888888711111112";
    QTest::newRow("row12")<<"123456789"<<"987654321"<<"121932631112635269";
    QTest::newRow("row13")<<"9999999999"<<"100"<<"999999999900";
    QTest::newRow("row14")<<"1234567899"<<"1234567899"<<"1524157897241274201";
    QTest::newRow("row15")<<"123456789987654321"<<"123456789987654321"<<"15241578994055784200731595789971041";
}
...
void project_tests::test_mathDiv_data(){
    ...
    QTest::addColumn<QString>("secondNum");
    QTest::addColumn<QString>("result");
    QTest::newRow("row1")<<"2"<<"0"<<"Error div 0";
    QTest::newRow("row2")<<"0"<<"2"<<"0";
    QTest::newRow("row3")<<"8"<<"2"<<"4";
    QTest::newRow("row4")<<"8"<<"4"<<"2";
    QTest::newRow("row5")<<"24"<<"25"<<"0";
    QTest::newRow("row6")<<"144"<<"14"<<"10";
    QTest::newRow("row7")<<"144"<<"12"<<"12";
    QTest::newRow("row8")<<"9999"<<"9"<<"1111";
    QTest::newRow("row9")<<"48954"<<"246"<<"199";
    QTest::newRow("row10")<<"999999999"<<"3"<<"333333333";
    QTest::newRow("row11")<<"151658732170"<<"1231546"<<"123145";
    QTest::newRow("row12")<<"121932631112635269"<<"123456789"<<"987654321";
    QTest::newRow("row13")<<"5252683697925751630154898"<<"42546738"<<"123456789987654321";
    QTest::newRow("row14")<<"137174211083676268890260631"<<"1111111111"<<"123456789987654321";
    QTest::newRow("row15")<<"15241578994055784200731595789971041"<<"123456789987654321"<<"123456789987654321";
}
...
void project_tests::test_full_calculate_data(){
    ...
    QTest::newRow("row9")<<"((12*12)/12)+((13*13)/13)"<<"25";
    QTest::newRow("row10")<<"((((16*14)/2)/2)/2)/2"<<"14";
    QTest::newRow("row11")<<"((((30*49)-70)/(4+(14*14)))*10)/((46+4)/(10/2))"<<"7";
}
