...
ValueInfo::ValueInfo()
{
    ...
    std::vector<std::vector<double>> value{{4046.8564224,100,10000,0.0001,0.09290304,0.00064516,1},
                                          {0.001,0.01,1,1000,0.0254,0.3048,0.9144,1609.344,1852,0.0000254},
                                          {1,1,1,1,1,1,1,1,1},
